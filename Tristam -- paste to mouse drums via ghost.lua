...
mousepos_snap = reaper.SnapToGrid(0,mousepos)





reaper.GetSet_LoopTimeRange2(0,1,0,mousepos_snap, mousepos_snap+(endtime-starttime),0)
...
reaper.SetEditCurPos(mousepos_snap+ offset+diff,0,0)
