...
function main()
  ...
  for i, item in ipairs(init_sel_items) do
    ...
    if take and not reaper.TakeIsMIDI( take ) then
      ...
      reaper.BR_SetItemEdges( item, new_start_item, new_start_item + dist )
      
      reaper.SetMediaItemPosition( item, tstart, 0 )

      
      reaper.SetMediaItemInfo_Value(item, "D_FADEOUTLEN", fade/2)
